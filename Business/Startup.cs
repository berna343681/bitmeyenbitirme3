...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IOrderİtemRepository, OrderİtemRepository>();
            services.AddTransient<IOrderRepository, OrderRepository>();
            services.AddTransient<INotificationRepository, NotificationRepository>();
            services.AddTransient<IErrorRaportRepository, ErrorRaportRepository>();
            services.AddTransient<ICustomerRepository, CustomerRepository>();
            services.AddTransient<ICompodentRepository, CompodentRepository>();
            services.AddTransient<IColorRepository, ColorRepository>();
            services.AddTransient<ICartİtemRepository, CartİtemRepository>();
